...
// export const Red = Color.Register("red");
// export const Orange = Color.Register("orange");
// export const Amber = Color.Register("amber");
// export const Yellow = Color.Register("yellow");
// export const Lime = Color.Register("lime");
// export const Green = Color.Register("green");
// export const Emerald = Color.Register("emerald");
// export const Teal = Color.Register("teal");
// export const Cyan = Color.Register("cyan");
// export const Sky = Color.Register("sky");
// export const Blue = Color.Register("blue");
// export const Indigo = Color.Register("indigo");
// export const Violet = Color.Register("violet");
// export const Purple = Color.Register("purple");
// export const Fuchsia = Color.Register("fuchsia");
// export const Pink = Color.Register("pink");
// export const Rose = Color.Register("rose");
// export const Slate = Color.Register("slate");
// export const Gray = Color.Register("gray");
// export const Zinc = Color.Register("zinc");
// export const Neutral = Color.Register("neutral");
// export const Stone = Color.Register("stone");

export const Red = Color.Register("red", 0.637, 0.237, 25.331);
export const Orange = Color.Register("orange", 0.705, 0.213, 47.604);
export const Amber = Color.Register("amber", 0.769, 0.188, 70.08);
export const Yellow = Color.Register("yellow", 0.795, 0.184, 86.047);
export const Lime = Color.Register("lime", 0.768, 0.233, 130.85);
export const Green = Color.Register("green", 0.723, 0.219, 149.579);
export const Emerald = Color.Register("emerald", 0.696, 0.17, 162.48);
export const Teal = Color.Register("teal", 0.704, 0.14, 182.503);
export const Cyan = Color.Register("cyan", 0.715, 0.143, 215.221);
export const Sky = Color.Register("sky", 0.685, 0.169, 237.323);
export const Blue = Color.Register("blue", 0.623, 0.214, 259.815);
export const Indigo = Color.Register("indigo", 0.585, 0.233, 277.117);
export const Violet = Color.Register("violet", 0.606, 0.25, 292.717);
export const Purple = Color.Register("purple", 0.627, 0.265, 303.9);
export const Fuchsia = Color.Register("fuchsia", 0.667, 0.295, 322.15);
export const Pink = Color.Register("pink", 0.656, 0.241, 354.308);
export const Rose = Color.Register("rose", 0.645, 0.246, 16.439);
export const Slate = Color.Register("slate", 0.554, 0.046, 257.417);
export const Gray = Color.Register("gray", 0.551, 0.027, 264.364);
export const Zinc = Color.Register("zinc", 0.552, 0.016, 285.938);
export const Neutral = Color.Register("neutral", 0.556, 0, 0);
export const Stone = Color.Register("stone", 0.553, 0.013, 58.071);
// export const Black = Color.Register("black", 0, 0, 0);
// export const White = Color.Register("white", 1, 0, 0);
// export const Transparent = Color.Register("transparent", 1, 0, 0, 0);
...
export const Opacity55 = Opacity.Register("opacity-55", 0.55);
...
export const A0 = Alpha.Register("alpha-0", 0.00);
export const A5 = Alpha.Register("alpha-5", 0.05);
export const A10 = Alpha.Register("alpha-10", 0.10);
export const A15 = Alpha.Register("alpha-15", 0.15);
export const A20 = Alpha.Register("alpha-20", 0.20);
export const A25 = Alpha.Register("alpha-25", 0.25);
export const A30 = Alpha.Register("alpha-30", 0.30);
export const A35 = Alpha.Register("alpha-35", 0.35);
export const A40 = Alpha.Register("alpha-40", 0.40);
export const A45 = Alpha.Register("alpha-45", 0.45);
export const A50 = Alpha.Register("alpha-50", 0.50);
export const A55 = Alpha.Register("alpha-55", 0.55);
export const A60 = Alpha.Register("alpha-60", 0.60);
export const A65 = Alpha.Register("alpha-65", 0.65);
export const A70 = Alpha.Register("alpha-70", 0.70);
export const A75 = Alpha.Register("alpha-75", 0.75);
export const A80 = Alpha.Register("alpha-80", 0.80);
export const A85 = Alpha.Register("alpha-85", 0.85);
export const A90 = Alpha.Register("alpha-90", 0.90);
export const A95 = Alpha.Register("alpha-95", 0.95);
export const A100 = Alpha.Register("alpha-100", 1.00);

// export const Paper10 = Paper.Register("paper-10", 0.10);
// export const Paper20 = Paper.Register("paper-20", 0.20);
// export const Paper30 = Paper.Register("paper-30", 0.30);
// export const Paper40 = Paper.Register("paper-40", 0.40);
// export const Paper50 = Paper.Register("paper-50", 0.50);
// export const Paper60 = Paper.Register("paper-60", 0.60);
// export const Paper70 = Paper.Register("paper-70", 0.70);
// export const Paper80 = Paper.Register("paper-80", 0.80);
// export const Paper90 = Paper.Register("paper-90", 0.90);

// export const Ink10 = Ink.Register("ink-10", 0.10);
// export const Ink20 = Ink.Register("ink-20", 0.20);
// export const Ink30 = Ink.Register("ink-30", 0.30);
// export const Ink40 = Ink.Register("ink-40", 0.40);
// export const Ink50 = Ink.Register("ink-50", 0.50);
// export const Ink60 = Ink.Register("ink-60", 0.60);
// export const Ink70 = Ink.Register("ink-70", 0.70);
// export const Ink80 = Ink.Register("ink-80", 0.80);
// export const Ink90 = Ink.Register("ink-90", 0.90);

export const T5 = Tone.Register("tone-5", -0.90);
export const T10 = Tone.Register("tone-10", -0.80);
export const T15 = Tone.Register("tone-15", -0.70);
export const T20 = Tone.Register("tone-20", -0.60);
export const T25 = Tone.Register("tone-25", -0.50);
export const T30 = Tone.Register("tone-30", -0.40);
export const T35 = Tone.Register("tone-35", -0.30);
export const T40 = Tone.Register("tone-40", -0.20);
export const T45 = Tone.Register("tone-45", -0.10);
export const T50 = Tone.Register("tone-50", 0.00);
export const T55 = Tone.Register("tone-55", 0.10);
export const T60 = Tone.Register("tone-60", 0.20);
export const T65 = Tone.Register("tone-65", 0.30);
export const T70 = Tone.Register("tone-70", 0.40);
export const T75 = Tone.Register("tone-75", 0.50);
export const T80 = Tone.Register("tone-80", 0.60);
export const T85 = Tone.Register("tone-85", 0.70);
export const T90 = Tone.Register("tone-90", 0.80);
export const T95 = Tone.Register("tone-95", 0.90);
