...
import {SizeOf} from "/js/External/SizeOf.js";
...
export class Debug
{
  static IsGlobalThis(v){ return v === globalThis ? this : undefined; }
  static IsUndefined(v){ return v === undefined ? this : undefined; }
  static IsNull(v){ return v === null ? this : undefined; }
  static IsNotDefined(v){ return (v === undefined) || (v === null) ? this : undefined; }
  static IsDefined(v){ return (v !== undefined) && (v !== null) ? this : undefined; }
  static IsInfinity(v){ return v === Infinity ? this : undefined; }
  static IsTrue(v){ return v === true ? this : undefined; }
  static IsFalse(v){ return v === false ? this : undefined; }
  static IsTruthy(v){ return v ? true : false ? this : undefined; }
  static IsFalsy(v){ return v ? false : true ? this : undefined; }
  static IsOnServer(v){ return Environment.IsServer() === true ? this : undefined; }
  static IsOnClient(v){ return Environment.IsClient() === true ? this : undefined; }
  static IsInlineFrame(v){ return Environment.IsInlineFrame() === true ? this : undefined; }
  ...
  {
    if (!Debug.Function(fn)) return;
    return Promise.resolve(fn()).then(r => this).catch(e => undefined);
  }

  static Rejecting(fn)
  {
    if (!Debug.Function(fn)) return;
    return Promise.resolve(fn()).then(r => undefined).catch(e => this);
  }

  static UpperCase(v){ return v.toUpperCase() === v ? this : undefined; }
  static LowerCase(v){ return v.toLowerCase() === v ? this : undefined; }
  static AllDigits(v){ return /^\d+$/.test(v) ? this : undefined; }
  ...
  {
    return SizeOf(value, visited);
  }
}

export class Check extends Debug
{
  static Fail(reason)
  {
